...
class Action(VirtualActionItem):
    ...
    def _add_comment_to_maintenance_event(self, user_id, comment_content, is_human_made=False):
        """Add comment to the maintenance action set"""
        if self.maintenance_action_set:
            self.maintenance_action_set.add_comment_to_event(user_id, comment_content, is_human_made=is_human_made)
    ...
    def complete_action(self, user_id, notes=None, status='Completed', billable_hours=None):
        ...
        self._add_comment_to_maintenance_event(user_id, comment_content, is_human_made=is_human_made)
