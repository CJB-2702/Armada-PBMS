...
class MaintenanceService:
    ...
    def get_create_event_form_options() -> Dict[str, List]:
        ...
        # Returns: {'assets': [...], 'template_actions': [...]}
```
...
- Form option retrieval (asset_types, make_models, template_actions)
...
class MaintenancePlanService:
    ...
    def get_form_options() -> Dict[str, List]:
        ...
        # Returns: {'asset_types': [...], 'make_models': [...], 'template_actions': [...]}
...
**From `create()` and `edit()` routes:**
- Form option retrieval (assets, template_actions, maintenance_plans)
...
class MaintenanceActionSetService:
    ...
    def get_form_options() -> Dict[str, List]:
        """Get form options for create/edit forms"""
        # Returns: {'assets': [...], 'template_actions': [...], 'maintenance_plans': [...]}
        
    @staticmethod
    def search_proto_action_items(
        query: Optional[str] = None,
        page: int = 1,
        page_size: int = 16
    ) -> List[ProtoActionItems ]:
...
**From `create()` route:**
- Form option retrieval (maintenance_action_sets, proto_action_items)
...
class ActionService:
    ...
    def get_form_options() -> Dict[str, List]:
        ...
        # Returns: {'maintenance_action_sets': [...], 'proto_action_items': [...]}
```
...
### Logic to Move from `presentation/routes/maintenance/template_actions.py`:
...
### Logic to Move from `presentation/routes/maintenance/proto_action_items.py`:

**From `list()` route:**
- Query building with filtering (template_action_set_id, action_name, is_required)
- Pagination
- Form option retrieval (template_actions)
...
class ProtoActionItemervice:
    ...
    def get_list_data(
        ...
        # Returns: (pagination_object, {'template_actions': [...]})
        
    @staticmethod
    def get_form_options() -> Dict[str, List]:
        """Get form options for create/edit forms"""
        # Returns: {'template_actions': [...]}
...
- Pagination
- Form option retrieval (proto_action_items, parts)
...
class TemplatePartDemandService:
    ...
    def get_list_data(
        ...
        # Returns: (pagination_object, {'proto_action_items': [...], 'parts': [...]})
        
    @staticmethod
    def get_form_options() -> Dict[str, List]:
        """Get form options for create/edit forms"""
        # Returns: {'proto_action_items': [...], 'parts': [...]}
```
...
- Pagination
- Form option retrieval (proto_action_items, tools)
...
class TemplateActionToolService:
    ...
    def get_list_data(
        ...
        # Returns: (pagination_object, {'proto_action_items': [...], 'tools': [...]})
        
    @staticmethod
    def get_form_options() -> Dict[str, List]:
        """Get form options for create/edit forms"""
        # Returns: {'proto_action_items': [...], 'tools': [...]}
```
...
1. Implement `TemplateActionsService`
2. Implement `ProtoActionItemervice`
