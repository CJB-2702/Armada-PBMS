...
This system design is split into two focused documents for better organization and maintainability:

### 📋 [Application Design Document](ApplicationDesign.md)
**Focus**: Application architecture, technology decisions, and development workflow
- Technology stack and coding standards
- Application architecture and build system
- File structure and organization
- Application features and HTMX implementation
- User management system
- Development workflow and phases
- Code quality standards and security considerations

### 📊 [Data Model Design Document](DataModelDesign.md)
**Focus**: Data modeling, entity relationships, and database design
...
- **Frontend**: HTMX for dynamic interactions, minimal Alpine.js for complex interactions
- **Database**: SQLite (development)
- **File Operations**: `pathlib.Path` for all file operations

### Development Phases
- **Phase 1**: Core Foundation (✅ Complete)
- **Phase 2**: Asset Detail System (✅ Complete)
- **Phase 3**: Maintenance System (📋 Planned)
- **Phase 4**: Dispatch System (📋 Planned)
- **Phase 5**: Inventory Management (📋 Planned)
- **Phase 6**: Planning System (📋 Planned)

### Current Status
- **Core Foundation**: Complete with user management, asset hierarchy, and audit trail
- **Asset Detail System**: Complete with flexible detail tables and automatic insertion
- **Basic UI**: Complete with authentication and asset management interface
- **Future Systems**: Planned and documented for implementation

## Getting Started

1. **Read Application Design**: Start with `ApplicationDesign.md` for architecture and workflow
2. **Review Data Model**: Consult `DataModelDesign.md` for entity relationships
3. **Check Implementation**: See `Phase2RestructurePlan.md` for implementation details
4. **Review Status**: Check individual phase status documents in `phase_*/` directories
...
- Scalable build system with phase-specific options

### 2. Flexible Data Model
- Hierarchical asset relationships (Asset → MakeModel → AssetType)
- Extensible detail table system with virtual templates
- Configuration-based detail table assignments
...
- User-created base class for all entities
- System user for automated processes

## References

### Documentation
- **[Application Design](ApplicationDesign.md)**: Application architecture and development workflow
- **[Data Model Design](DataModelDesign.md)**: Entity relationships and database design
- **[Phase 2 Restructure Plan](Phase2RestructurePlan.md)**: Implementation details for Phase 2 restructuring

### Status Documents
- **[Phase 1 Status](phase_1/PHASE1_STATUS.md)**: Core foundation implementation status
- **[Phase 2 Status](phase_2/PHASE2_STATUS.md)**: Asset detail system implementation status
- **[Phase 3 Status](phase_3/PHASE3_STATUS.md)**: Automatic detail insertion implementation status
- **[Phase 4 Status](phase_4/PHASE4_STATUS.md)**: Basic UI implementation status

### Implementation Guides
- **[Phase 2 Restructure Summary](Phase2RestructureSummary.md)**: Summary of Phase 2 restructuring changes
- **[Development Plan](DevelopmentPlan.md)**: Overall development planning and workflow
- **[Development Checklist](DevelopmentChecklist.md)**: Detailed implementation checklist
...
### Environment
 - use Virtual enviroment in directory just below /app always
...
def build_database(build_phase='all', data_phase='all'):
    ...
    - 'phase2': Phase 1 + Asset Detail System (Infrastructure + Auto-Insertion)
    - 'phase3': Phase 1 + Phase 2 + Maintenance System
    - 'phase4': Phase 1 + Phase 2 + Phase 3 + Dispatch System
    ...
    - 'phase4': Phase 1 + Phase 2 + Phase 3 + Dispatch Data
...
#### Phase 2 Data Insertion Strategy
**Progressive Implementation Approach**:

- **Phase 2A (Manual Testing)**: Manually inserts detail table configurations and sample data for structure validation
- **Phase 2B (Automatic Creation)**: Assets automatically create empty detail table rows when created
- **Phase 2C (Data Management)**: Updates auto-generated detail rows with actual information

**Phase 2 Data Process**:
1. **Phase 2A**: Manual testing of detail table structure and relationships
2. **Phase 2B**: Asset Creation → Automatic detail rows created (empty)
3. **Phase 2C**: Row Population → Update auto-generated detail rows with actual data
...
Phase 2B (Automatic Creation):
- Create asset → Automatic detail rows created (empty)

Phase 2C (Data Management):
- Update auto-generated detail rows with actual data
```

**Benefits of Phase 2 Approach**:
- **Structure Validation**: Phase 2A validates table structure before automation
- **Consistency**: All assets automatically get the correct detail table structure
- **Efficiency**: No manual detail table row creation required in production
