...
from app.services.maintenance.template_action_tool_service import TemplateActionToolService
from app import db
...
def list():
    ...
    template_action_tools, form_options = TemplateActionToolService.get_list_data(
        page=page,
...
def create():
    ...
    form_options = TemplateActionToolService.get_form_options()
