...
from app.services.maintenance.template_part_demand_service import TemplatePartDemandService
from app import db
...
def list():
    ...
    is_optional_param = request.args.get('is_optional')
    is_optional = None if is_optional_param is None else (is_optional_param.lower() == 'true')
    ...
    template_part_demands, form_options = TemplatePartDemandService.get_list_data(
        page=page,
...
def create():
    ...
    form_options = TemplatePartDemandService.get_form_options()
