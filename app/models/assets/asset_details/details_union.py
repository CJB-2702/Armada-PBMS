...
from app import db
from app.models.assets.asset_details import PurchaseInfo, VehicleRegistration, ToyotaWarrantyReceipt
...
class AssetDetailsUnionService:
    """
    ...
    def get_all_details_for_asset(cls, asset_id: int) -> List[Dict[str, Any]]:
        ...
        for table_class in cls.ASSET_DETAIL_TABLES:
            records = table_class.query.filter_by(asset_id=asset_id).all()
