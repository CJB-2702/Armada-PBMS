...
def build_models():
    ...
    import app.models.maintenance.virtual_part_demand
    
    # Import base models
    import app.models.maintenance.base.action
    import app.models.maintenance.base.maintenance_action_set
    import app.models.maintenance.base.maintenance_plan
    import app.models.maintenance.base.maintenance_delays
    import app.models.maintenance.base.part_demand
    ...
    import app.models.maintenance.templates.template_action_set_attachment
    
    # Import factories
    import app.models.maintenance.factories.maintenance_action_set_factory
    import app.models.maintenance.factories.action_factory
    import app.models.maintenance.factories.part_demand_factory
    import app.models.maintenance.factories.maintenance_factory
    
    # Import utilities
    import app.models.maintenance.utils.maintenance_helpers
    import app.models.maintenance.utils.template_helpers
    import app.models.maintenance.utils.quick_actions
...
def create_maintenance_from_template(template_action_set_id, asset_id, user_id, **kwargs):
    ...
    """
    from app.models.maintenance.utils.quick_actions import QuickActions
