...
- **ActionFactory**: Factory for creating Actions from TemplateActionItems

### app/buisness/maintenance/factories/maintenance_action_set_factory.py

- **MaintenanceActionSetFactory**: Factory for creating MaintenanceActionSet from TemplateActionSet
...
## app/data/inventory/managers

### app/data/inventory/managers/__init__.py

- *No classes defined*

### app/data/inventory/managers/inventory_manager.py

- **InventoryManager**: Manages all inventory movements and levels

### app/data/inventory/managers/part_arrival_manager.py

- **PartArrivalManager**: Handles receiving and inspection workflow

### app/data/inventory/managers/part_demand_manager.py

- **PartDemandManager**: Extends maintenance part demand for purchasing integration

### app/data/inventory/managers/purchase_order_manager.py

- **PurchaseOrderManager**: Handles all purchase order business logic

## app/data/inventory/utils

### app/data/inventory/utils/__init__.py
...
## app/data/maintenance/factories

### app/data/maintenance/factories/__init__.py

- *No classes defined*

### app/data/maintenance/factories/action_factory.py

- **ActionFactory**: Factory for creating Actions from TemplateActionItems

### app/data/maintenance/factories/maintenance_action_set_factory.py

- **MaintenanceActionSetFactory**: Factory for creating MaintenanceActionSet from TemplateActionSet

### app/data/maintenance/factories/maintenance_event_factory.py

- **MaintenanceActionSetFactory**: Factory for creating MaintenanceActionSet from TemplateActionSet

### app/data/maintenance/factories/maintenance_factory.py

- **MaintenanceFactory**: Main factory for creating complete maintenance workflows from templates

### app/data/maintenance/factories/maintenance_plan_factory.py

- **MaintenancePlanFactory**: Factory for creating MaintenancePlans and related operations

### app/data/maintenance/factories/part_demand_factory.py
...
### app/data/maintenance/templates/template_action_item.py

- **TemplateActionItem** (VirtualActionItem): No description available

### app/data/maintenance/templates/template_action_set.py

- **TemplateActionSet** (VirtualActionSet): No description available

### app/data/maintenance/templates/template_action_set_attachment.py

- **TemplateActionSetAttachment** (VirtualAttachmentReference): No description available
...
## app/data/maintenance/utils

### app/data/maintenance/utils/__init__.py

- *No classes defined*

### app/data/maintenance/utils/maintenance_helpers.py

- **MaintenanceHelpers**: Utility functions for maintenance operations

### app/data/maintenance/utils/quick_actions.py

- **QuickActions**: Quick action functions for common maintenance operations

### app/data/maintenance/utils/template_helpers.py
...
### app/presentation/routes/maintenance/template_action_items.py

- *No classes defined*

### app/presentation/routes/maintenance/template_action_sets.py
