...
def create_assign():
    ...
    try:
        ...
        return render_template(
            'maintenance/manager/create_assign.html',
            templates=templates,
...
def create_event():
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render_template(
                'maintenance/manager/create_event.html',
                templates=templates,
                technicians=technicians,
                asset_types=asset_types,
                make_models=make_models,
...
def unassigned_events():
    ...
    try:
        ...
        return render_template(
            'maintenance/manager/unassigned_events.html',
            events=events,
            technicians=technicians,
            asset_types=asset_types,
            current_filters={
...
def search_bars_templates():
    ...
    try:
        ...
        return render_template(
            'maintenance/manager/search_bars/templates_results.html',
            templates=templates,
...
def search_bars_assets():
    ...
    try:
        ...
        return render_template(
            'maintenance/manager/search_bars/assets_results.html',
            assets=assets,
            total_count=total_count,
            showing=len(assets),
            search=search,
...
def search_bars_assignment():
    ...
    try:
        ...
        return render_template(
            'maintenance/manager/search_bars/assignment_results.html',
            technicians=technicians,
            total_count=total_count,
