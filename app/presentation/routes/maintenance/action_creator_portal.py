...
def action_creator_portal(maintenance_action_set_id):
    ...
    try:
        ...
        return render_template(
            'maintenance/action_creator_portal.html',
...
def search_template_action_sets():
    ...
    try:
        ...
        return render_template(
            'maintenance/action_creator_portal/search_template_action_sets.html',
...
def search_template_actions():
    ...
    try:
        ...
        return render_template(
            'maintenance/action_creator_portal/search_template_actions.html',
...
def search_proto_actions():
    ...
    try:
        ...
        return render_template(
            'maintenance/action_creator_portal/search_proto_actions.html',
...
def list_template_action_items(template_action_set_id):
    ...
    try:
        ...
        return render_template(
            'maintenance/action_creator_portal/list_template_action_items.html',
